...
public abstract class BaseHuskySequenceCoder<X extends CharSequence> implements HuskySequenceCoder<X> {
     ...
     */
    @Override
    final public edu.neu.coe.huskySort.sort.huskySortUtils.Coding huskyEncode(final X[] xs) {
        ...
        return new edu.neu.coe.huskySort.sort.huskySortUtils.Coding(result, isPerfect);
    }
