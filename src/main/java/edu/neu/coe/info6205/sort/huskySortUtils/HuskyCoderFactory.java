...
public final class HuskyCoderFactory {
     ...
     */
    public static <X extends HuskySortable<X>> edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<X> createGenericCoder() {
     ...
     */
    public final static edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<Date> dateCoder = new edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<Date>() {
        /**
         * Encode x as a long.
         * As much as possible, if x > y, huskyEncode(x) > huskyEncode(y).
         * If this cannot be guaranteed, then the result of imperfect(z) will be true.
     ...
     */
    public final static edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<ChronoLocalDateTime<?>> chronoLocalDateTimeCoder = new edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<ChronoLocalDateTime<?>>() {
        @Override
     ...
     */
    public final static edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<Double> doubleCoder = HuskyCoderFactory::doubleToLong;

    /**
     * A Husky Coder for Integers.
     */
    public final static edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<Integer> integerCoder = new edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<Integer>() {
        @Override
     ...
     */
    public final static edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<Long> longCoder = new edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<Long>() {
        @Override
     ...
     */
    static abstract class ProbabilisticEncoder<X extends Number & Comparable<X>> implements edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<X> {
        @Override
     ...
     */
    public final static edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<BigInteger> bigIntegerCoder = x -> doubleToLong(x.doubleValue());

    /**
     * A Husky Coder for BigDecimals.
     */
    public final static edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<BigDecimal> bigDecimalCoder = BigDecimal::longValue;
     ...
     */
    public static edu.neu.coe.huskySort.sort.huskySortUtils.HuskyCoder<BigDecimal> scaledBigDecimalCoder(final int scale) {
